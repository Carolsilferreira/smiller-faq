...
{q:'Como  funciona o SmillerPay?', a:'Na etapa de aprovação do caso na plataforma, você poderá selecionar a opção “Cobrar o paciente”. Ao escolher essa modalidade, basta informar o valor total do tratamento, e a Smiller se encarrega do restante:<br>1- Você informa o valor total do tratamento diretamente na plataforma na hora da aprovação.<br>2 - Nós geramos automaticamente um link de pagamento personalizado no nome do paciente, com opções de PIX à vista ou cartão de crédito em até 18x.<br>3- Nessa etapa, será necessário preencher alguns dados para o cadastro do dentista e do pagador (paciente ou responsável). <br>4- Após a confirmação, você receberá o seu lucro de forma antecipada, enquanto a Smiller assume toda a gestão financeira, incluindo a cobrança ao paciente.  <br><br>Com isso, você não precisa se preocupar com inadimplência, controle de boletos ou acompanhamento de pagamentos.'},
