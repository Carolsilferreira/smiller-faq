const dadosIniciais = [
  ...
  {q:'Como funcionam as contenções?', a:'As contenções da Smiller são placas semelhantes às dos alinhadores, mas um pouco mais espessas. Nossa recomendação é a utilização delas durante a noite por aproximadamente 1 ano e meio e que a troca seja feita de 6 em 6 meses, por isso indicamos a aquisição do pacote com 3 pares.'},
  {q:'Qual prazo de entrega das contenções?', a:'Prazo de 5 dias úteis de fabricação + prazo de entrega para sua cidade.'},
  {q:'Como solicitar placa de bruxismo?', a:'-Envio do escaneamento via plataforma<br>- Preenchimento do formulário de solicitação de tratamento, marcando a opção "Placas de Bruxismo": https://app.smiller.com.br/NovoPaciente<br>Nossas placas de bruxismo são feitas a base de resina acrílica e o valor de cada placa é R$449,90<br>O prazo de fabricação é de 7 dias úteis + o prazo de entrega para sua cidade.'},
  ...
  {q:'O que fazer em caso de perda de placa pelo paciente?', a:'Recomendamos ao paciente usar a placa anterior até orientação. Se necessário, solicite uma reposição da placa. Para reposição de placas cobramos um valor de 35,90 por unidade de placa.'},
  {q:'Como funciona o refinamento?', a:'Nosso refinamento padrão compreende na quantidade de placas total do pacote pago menos a quantidade de placas programadas para o seu planejamento inicial aprovado + 12 placas inclusas para refinamento. Por exemplo: se o planejamento tem 40 placas (dentro da faixa de 32 a 51), sobram 11 placas (51 - 40) + 12 de refinamento. Essas 23 placas podem ser usadas no refinamento sem custo extra.'},
  ...
  {q:'Como realizar o seu acesso? ', a:'Email para login:<br>Site para acesso: https://app.smiller.com.br<br>Como fazer o primeiro acesso: https://youtu.be/1AAwjXokDHc?si=rOHEs3LTLMlXBOJM.'},
  ...
  {q:'Como aprovar pelo SmillerPay?', a:'Na etapa de aprovação do caso na plataforma, você poderá selecionar a opção "Cobrar o paciente". Ao escolher essa modalidade, basta informar o valor total do tratamento, e a Smiller se encarrega do restante: <br><br> 1- Você informa o valor total do tratamento diretamente na plataforma na hora da aprovação. <br><br>2 - Nós geramos automaticamente um link de pagamento personalizado no nome do paciente, com opções de PIX à vista ou cartão de crédito em até 18x. <br><br> 3- Nessa etapa, será necessário preencher alguns dados para o cadastro do dentista e do pagador (paciente ou responsável). <br><br> 4- Após a confirmação, você receberá o seu lucro de forma antecipada pela conta digital da ASAAS, onde o dinheiro de suas vendas será depositado, enquanto a Smiller assume toda a gestão financeira, incluindo a cobrança ao paciente.<br><br> Com isso, você não precisa se preocupar com inadimplência, controle de boletos ou acompanhamento de pagamentos.'},
  {q:'Como aprovar o meu caso?', a:'As aprovações são realizadas diretamente pela plataforma.<br>Site para acesso: https://app.smiller.com.br/MeusPacientes'},
  {q:'Qual o material e espessura da contenção?', a:'Nossa contenção tem a espessura de 1,0 mm e são fabricadas em polietileno tereftalato glicol (PETG)'},
  {q:'Como funciona o Smiller Pay?', a:'O Smiller Pay é um método de pagamento da Smiller que facilita a cobrança do tratamento diretamente ao paciente.<br><br>Ao aprovar o caso na plataforma, você irá informar o valor total do tratamento que gostaria de cobrar. A Smiller então gera um link de pagamento no nome do paciente, que poderá pagar via PIX ou cartão de crédito em até 18x. Após a confirmação do pagamento, o seu lucro é antecipado pela conta digital da ASAAS, enquanto a Smiller fica responsável por toda a gestão financeira, incluindo cobrança e acompanhamento dos pagamentos. Assim, você não precisa se preocupar com inadimplência ou controle de parcelas.<br><br>No Smiller Pay há taxa de antecipação de 1,6% ao mês no cartão e taxa de serviço fixa de 2% sobre o valor total cobrado.<br><br>Sobre as notas fiscais: a Smiller emite a Nota Fiscal referente ao custo dos alinhadores diretamente ao paciente e o dentista responsável emite uma Nota Fiscal complementar referente à diferença do valor total do tratamento e o valor de custo dos alinhadores'},
  {q:'Os alinhadores tem garantia?', a:'O sucesso do tratamento e a garantia dos resultados estão diretamente ligados ao correto seguimento do plano estabelecido e ao comprometimento do paciente com o uso adequado dos alinhadores, bem como à assiduidade nas consultas. Em nosso protocolo, o planejamento inicial é cuidadosamente elaborado para alcançar os resultados desejados. No entanto, compreendemos que cada organismo responde de maneira única, e fatores como variações biológicas e no tempo de uso dos alinhadores podem influenciar no movimento dental.<br><br>Caso, ao final do ciclo inicial, o paciente não esteja totalmente satisfeito, avaliamos a possibilidade de refinamentos, desde que todas as recomendações tenham sido seguidas corretamente. É importante ressaltar que cerca de 20 a 30% dos casos exigem ajustes no planejamento original, o que é uma característica intrínseca do sistema de alinhadores. O refinamento, portanto, não representa uma falha, mas sim nosso compromisso com a perfeição, garantindo que o resultado seja alcançado dentro dos parâmetros preestabelecidos.'},
  {q:'Condições de pagamentos', a:'DENTISTA NOVO: Atualmente as condições de pagamento são definidas com base em uma análise de crédito, utilizando informações do score Serasa. Essa análise nos permite oferecer condições mais seguras e personalizadas para cada caso. De qualquer forma, conforme o relacionamento for evoluindo e tivermos histórico de pedidos e pagamentos, essas condições podem ser reavaliadas e ajustadas.<br><br>DENTISTA ANTIGO: Recentemente realizamos uma atualização nas condições de pagamento, baseada em uma análise de crédito considerando o histórico financeiro e de pagamentos. Por isso, pode ter ocorrido um ajuste nas condições atuais. Mas conforme formos avançando com novos pedidos e mantendo um bom histórico, conseguimos reavaliar e melhorar essas condições futuramente.'},
